...
1. Run one mobile loop sanity pass across Today, one grammar mission, one listening mission, Review, Progress, and Missions after the recent copy/highlight cleanups.
2. Begin the next narrow personalization slice only after the current mobile loop still feels clean under user testing.
