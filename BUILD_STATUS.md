...
- Today is now more review-aware and more personally explained, but recommendation logic is still intentionally simple and deterministic rather than adaptive or scheduled
...
1. Run a V2.0-V2.5 plus listening-prep-audio mobile acceptance audit before adding more implementation work: Today, first grammar/listening/output missions, Review, Progress, and Missions.
2. Keep date-keyed daily sessions, new mission types, richer SRS intervals, and broader content-model changes deferred unless more real-use feedback explicitly accepts that larger model change.
