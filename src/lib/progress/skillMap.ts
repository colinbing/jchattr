...
const SKILL_SIGNAL_DEFINITIONS: SkillSignalDefinition[] = [
  {
    ...
    grammarLessonIds: [
      ...
      'grammar-waiting-status-lines',
      'grammar-time-ranges-kara-made',
      'grammar-time-range-questions',
      'grammar-calendar-when-questions',
      'grammar-calendar-date-lines',
      'grammar-calendar-appointment-lines',
      'grammar-calendar-plan-combination',
      'grammar-quantity-request-lines',
      'grammar-price-ikura-questions',
      'grammar-price-yen-lines',
      'grammar-shopping-availability-arimasu-ka',
      'grammar-shopping-selection-korede-ii-desu',
      'grammar-comparison-yori-houga-adjectives',
      'grammar-comparison-yori-houga-preferences',
    ],
  ...
  },
  {
    ...
    grammarLessonIds: [
      ...
      'grammar-waiting-status-lines',
      'grammar-suggestion-masenka-basics',
      'grammar-suggestion-masenka-activities',
      'grammar-mashou-plan-proposals',
      'grammar-mashou-plan-questions',
      'grammar-te-form-core-familiar-verbs',
      'grammar-te-form-core-sound-change-basics',
      'grammar-action-sequence-te-sorekara',
      'grammar-action-sequence-tekara',
      'grammar-progressive-actions-teimasu',
      'grammar-progressive-states-teimasu',
      'grammar-adjective-negatives-i',
      'grammar-adjective-negatives-na',
      'grammar-adjective-past-i',
      'grammar-adjective-past-na',
    ],
    itemTypes: ['grammar-drill', 'listening-check', 'output-task'],
    available: true,
  },
